...
test('month calendar displays session marker and opens day details',()=>{
 ...
 assert.match(markup,/calendar-dot scheduled/);assert.match(markup,/openCalendarDay\('2026-09-17'\)/);
